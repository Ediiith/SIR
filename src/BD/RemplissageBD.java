...
public class RemplissageBD {
    ...
    public static void main(String[] args) {
        ...
        //creation de 15 DMR
        creerDMR(1, "Martin", "Chloe", "31/12/1965", Genre.FEMME, "12 Rue Simon Nora, 38000 Grenoble", 1);
        creerDMR(2, "Bernard", "Lucas", "12/02/1985", Genre.HOMME, "17 Rue du Phalanstère, 38000 Grenoble", 2);
        creerDMR(3, "Dubois", "Lea", "02/04/1967", Genre.FEMME, "28 Boulevard Gambetta, 38000 Grenoble", 3);
        creerDMR(4, "Thomas", "Louis", "23/11/1954", Genre.HOMME, "635 Chemin de la Laurelle, 38330 Montbonnot-Saint-Martin", 4);   
        creerDMR(5, "Robert", "Jade", "02/04/1995", Genre.FEMME, "8 Avenue Esclangon, 38610 Gières", 5);
        creerDMR(6, "Richard", "Gabriel", "12/12/2000", Genre.HOMME, "32 Rue du Repos, 38610 Gières", 6);
        creerDMR(7, "Petit", "Manon", "08/09/1999", Genre.FEMME, "46 Avenue Jean Jaurès, 38400 Saint-Martin-d Hères", 7);
        creerDMR(8, "Durand", "Jules", "23/12/2010", Genre.HOMME, "7 Rue Flora Tristan, 38400 Saint-Martin-d Hères", 8);
        creerDMR(9, "Leroy", "Louise", "31/07/1934", Genre.FEMME, "24 Avenue Gabriel Péri, 38400 Saint-Martin-d Hères", 9);
        creerDMR(10, "Moreau", "Timeo", "23/05/1984", Genre.HOMME, "42 Boulevard Clemenceau, 38100 Grenoble", 10);
        creerDMR(11, "Simon", "Zoe", "01/12/2016", Genre.FEMME, "29 Avenue Jean Perrot, 38100 Grenoble", 11);
        creerDMR(12, "Laurent", "Hugo", "23/12/1963", Genre.HOMME, "22 Avenue Albert 1er de Belgique, 38100 Grenoble", 12);
        creerDMR(13, "Lefebvre", "Lilou", "06/08/1996", Genre.FEMME, "50 Boulevard Gambetta, 38000 Grenoble", 13);
        creerDMR(14, "Michel", "Arthur", "25/06/1973", Genre.HOMME, "11 Cours Berriat, 38000 Grenoble", 14);
        creerDMR(15, "Garcia", "Lena", "02/04/1946", Genre.FEMME, "14 Rue Félix Esclangon, 38000 Grenoble", 15);
        ...
        creerProfessionnel(4, "azerty", "Rousseau", "Nathalie", Statut.CHEF_SERVICE);
