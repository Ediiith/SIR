...
public class Associer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Connection.setText("l'examen au DMR ?");
        Connection.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        Valider1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        Valider1.setText("Non");
        ...
        Connection1.setText("Voulez vous associer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Associer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
